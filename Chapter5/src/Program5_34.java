 ...
 * scissor-rock-paper game. Revise the program to let the user continuously play until 
 * either the user or the computer wins more than two times than its opponent. 
 */
import java.util.Scanner;
public class Program5_34 {
	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		int computerWins, userWins ;//Counts the number of computer wins , counts the no.of user wins
		...
		if(win) {
			...
			computerWins++;//Increment computerWins
		}
		else {
